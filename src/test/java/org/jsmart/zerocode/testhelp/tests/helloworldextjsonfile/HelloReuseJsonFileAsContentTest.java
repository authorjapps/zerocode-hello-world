...
public class HelloReuseJsonFileAsContentTest {
    ...
    @Test
    @Scenario("helloworld_ext_file_json/hello_world_jsonfile_as_request_body.json")
    public void testHelloWorld_jsonFileAsBody() throws Exception {
    }

    @Test
    @Scenario("helloworld_ext_file_json/hello_world_jsonfile_as_response_body.json")
    public void testHello_jsonFileAsResponseBody() throws Exception {
    }

    @Test
    @Scenario("helloworld_ext_file_json/hello_world_jsonfile_as_part_payload.json")
