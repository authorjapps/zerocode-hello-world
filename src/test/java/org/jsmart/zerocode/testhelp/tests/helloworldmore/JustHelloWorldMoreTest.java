...
public class JustHelloWorldMoreTest {
    ...
    @Test
    @JsonTestCase("helloworld_tests/more/hello_world_post_201.json")
    public void testHelloWorld_post() throws Exception {

    }

    @Test
    @JsonTestCase("helloworld_tests/more/hello_world_get_new_emp_200.json")
    public void testHelloWorld_getTheNewEmp() throws Exception {

    }

    @Test
    @JsonTestCase("helloworld_tests/more/hello_world_all_integrated_apis.json")
