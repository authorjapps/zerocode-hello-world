...
public class JustHelloWorldMoreTest {
    ...
    @Test
    @Scenario("helloworld_more/hello_world_ok_status_200.json")
    public void testHelloWorld_localhostApi() throws Exception {
    }

    @Test
    @Scenario("helloworld_more/hello_world_post_201.json")
    public void testHelloWorld_post() throws Exception {
    }

    @Test
    @Scenario("helloworld_more/hello_world_get_new_emp_200.json")
    ...
    @Test
    @Scenario("helloworld_more/hello_world_json_tree.json")
